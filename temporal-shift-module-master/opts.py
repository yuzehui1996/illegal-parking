...
parser.add_argument('--store_name', type=str, default="videos_1218")
parser.add_argument('--modality', type=str, choices=['RGB', 'Flow'], default="RGB")
parser.add_argument('--train_list', type=str, default="/nfs/volume-95-7/temporal-shift-module/dataset/txt_list/1218/train.txt")
parser.add_argument('--val_list', type=str, default="/nfs/volume-95-7/temporal-shift-module/dataset/txt_list/1218/val.txt")
...
parser.add_argument('--tune_from', type=str, default='pretrained/TSM_kinetics_RGB_resnet50_shift8_blockres_avg_segment8_e50.pth', help='fine-tune from checkpoint')
