    ...
    def _load_image(self, directory, idx):
        if self.modality == 'RGB' or self.modality == 'RGBDiff':
            try:
                ...
                # img.save('/nfs/volume-95-7/temporal-shift-module/ops/vis/test_%d.jpg' % idx)
    ...
    def get(self, record, indices):
        ...
        for seg_ind in indices:
            ...
            for i in range(self.new_length):
                ...
                # if seg_ind == 0:
                    # print(np.array(seg_imgs[0]).shape)
                    # seg_imgs[0].save('./0.jpg')
                    # np.savetxt('./RGB.txt', np.array(seg_imgs[0])[:,:,0])
...
if __name__ == '__main__':
    ...
    test_file = '/nfs/volume-95-7/temporal-shift-module/ops/test_list.txt'

    data_loader = data.DataLoader(
        TSNDataSet('', test_file, num_segments=8,
                   new_length=1,
                   modality='RGB',
    ...
    # vis_path = './vis/'
    for data, label, path in data_loader:
        print(data.shape)  # 1,24,224,224
        # print(type(data))
        # data = data.cpu().numpy() # 1,24,224,224
        # cv2.imwrite()
        # data = data.reshape(1, 24*224*224)
        # print(data)
        # data = data[0][0].reshape(224*224)
        # np.savetxt('./input_src.txt', data[:100])
