...
# may contain splits
parser.add_argument('--weights', type=str, default='checkpoint/TSM_videos_1218_RGB_resnet50_shift8_blockres_avg_segment8_e120_pr8_ext0.1/ckpt.best.pth.tar')
...
# for true test
parser.add_argument('--test_list', type=str, default='/nfs/volume-95-7/temporal-shift-module/dataset/txt_list/videos_1201_500/test3.txt')
